...
komorebic container-padding 1 0 4

# Active window border
komorebic active-window-border enable
komorebic active-window-border-width 8
komorebic active-window-border-offset 8
komorebic active-window-border-colour 255 51 153 --window-kind single
komorebic active-window-border-colour 256 165 66 --window-kind stack
komorebic active-window-border-colour 66 165 245 --window-kind monocle
